...
SECRET_KEY = 'django-insecure-p@af9pa6hgbv&99!=xi4kcx%gc0f@n3o3_y7=5^6f7+=0!1ux4'
...
# Default file storage will use local, override it for S3
DEFAULT_FILE_STORAGE = 'django.core.files.storage.FileSystemStorage'  # Local file storage

# AWS S3 Storage for uploads
AWS_S3_FILE_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'
